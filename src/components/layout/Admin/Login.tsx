  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-10 px-4">
      ...
      <img 
        ...
        className="h-12 cursor-pointer mb-6 hover:opacity-90 transition-opacity"
        onClick={() => router.push('/')}
      />

      <form onSubmit={onSubmitHandler} className="w-full max-w-sm sm:max-w-md">
        <div className="flex flex-col gap-3 items-start p-8 border rounded-xl text-[#5E5E5E] text-sm shadow-lg bg-white w-full">
